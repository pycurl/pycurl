...
PYCURL_IGNORE_DEPRECATED_END
    ...
    insint_c(d, "SSH_COMPRESSION", CURLOPT_SSH_COMPRESSION);
#endif
#if LIBCURL_VERSION_NUM >= MAKE_LIBCURL_VERSION(7, 84, 0)
    insint_c(d, "SSH_HOSTKEYFUNCTION", CURLOPT_SSH_HOSTKEYFUNCTION);
#endif
...
#if LIBCURL_VERSION_NUM >= MAKE_LIBCURL_VERSION(7, 80, 0)
    insint_c(d, "SSH_HOST_PUBLIC_KEY_SHA256", CURLOPT_SSH_HOST_PUBLIC_KEY_SHA256);
#endif
...
#endif
#if LIBCURL_VERSION_NUM >= MAKE_LIBCURL_VERSION(7, 58, 0)
    insint_c(d, "SSH_AUTH_GSSAPI", CURLSSH_AUTH_GSSAPI);
#endif
...
# if LIBCURL_VERSION_NUM >= MAKE_LIBCURL_VERSION(7, 58, 0)
    insint_c(d, "KHTYPE_ECDSA", CURLKHTYPE_ECDSA);
    insint_c(d, "KHTYPE_ED25519", CURLKHTYPE_ED25519);
# endif
...
# if LIBCURL_VERSION_NUM >= MAKE_LIBCURL_VERSION(7, 73, 0)
    insint_c(d, "KHSTAT_FINE_REPLACE", CURLKHSTAT_FINE_REPLACE);
# endif
#endif

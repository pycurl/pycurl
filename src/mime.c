...
do_curlmime_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds)
{
    ...
    if (check_curl_state(curl, 1 | 2, "Mime") != 0) {
        return NULL;
    }
...
static PyMethodDef curlmimeobject_methods[] = {
    ...
    {"add_multipart", (PyCFunction)do_curlmime_add_multipart, METH_VARARGS | METH_KEYWORDS, "Add and attach a nested multipart Mime."},
    {"close", (PyCFunction)do_curlmime_close, METH_NOARGS, "Release the underlying curl_mime handle."},
    {"closed", (PyCFunction)do_curlmime_closed, METH_NOARGS, "Return whether this Mime object is closed."},
...
do_curlmimepart_subparts(CurlMimePartObject *self, PyObject *arg)
{
    ...
    if (!PyObject_TypeCheck(arg, p_CurlMime_Type)) {
        PyErr_SetString(PyExc_TypeError, "subparts() expects a Mime object");
        return NULL;
    }
...
static PyMethodDef curlmimepartobject_methods[] = {
    ...
    {"subparts", (PyCFunction)do_curlmimepart_subparts, METH_O, "Attach a child Mime object as multipart data."},
    {NULL, NULL, 0, NULL}
};

PYCURL_INTERNAL PyTypeObject CurlMimePart_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "pycurl.MimePart",         /* tp_name */
    ...
    0,                          /* tp_as_buffer */
    PYCURL_TYPE_FLAGS,          /* tp_flags */
    "A MIME part belonging to a Mime object.", /* tp_doc */
